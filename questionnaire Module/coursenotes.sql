...
INSERT INTO `question` VALUES (1,1,'What is my name','Hello','World','Name','Kim'),(2,1,'Who killed Voldemort','Hermione','Ron','Draco','Harry'),(3,1,'The boy who lived','Draco','Ron','Neville','Harry'),(4,1,'Voldermort\'s snake','me','you','him','Nagini'),(5,1,'My house','Griffindor','Slytherin','Hufflepuff','ravenclaw'),(6,2,'My lastname','potter','jackson','nothing','lopez'),(7,2,'Harry\'s mother','petunia','me','minerva','lily'),(8,2,'Harry\'s father','sirius','lupin','pettigrew','james'),(9,2,'I am a girl','False',NULL,NULL,'True'),(10,3,'Apache Tomcat is commonly referred as Tomcat Server?','False',NULL,NULL,'True'),(11,3,'The recommended file extension for JSP is ','.js','.html','.php','.jsp'),(12,3,'It is a technology that helps software and developers to create dynamically generated web pages on any browser language.','Php','Node','CSS','JSP'),(13,3,'JSP is an alternative to','JavaScript','Hypertext Transfer Protocol (HTTP)','Hypertext Preprocessor','Active Server Page (ASP) '),(14,3,'<%--...--%> The syntax is use for ','False',NULL,NULL,'True');
...
INSERT INTO `test` VALUES (1,'PHP',5),(2,'Servlet',3),(3,'JSP',5);
...
-- Dump completed on 2018-05-11 23:37:41
